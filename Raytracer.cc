...
int main () {
	Camera c(Vec3(0,0,0), Vec3(0,0,1), 90, 90, 0, 800, 800);
	Scene s(c);

	Sphere sph1 = Sphere(Vec3(0, 0, 30), 8, Vec3(20, 102, 20), 0.4, 0.9);
	Sphere sph2 = Sphere(Vec3(0, 0, 20), 2, Vec3(100, 40, 20), 3.99, 1.3);
	Sphere sph3 = Sphere(Vec3(-5, 0, 20), 2, Vec3(12, 32, 123), 0.4, 0.7);
	Sphere sph4 = Sphere(Vec3(0, 0, -10), 5, Vec3(12, 32, 123), 0.4, 0.7);

	Plane pla1 = Plane(Vec3(0, -50, 0), Vec3(0,-50, 100), Vec3(200, 170, 190), 0.7, 0.8);
