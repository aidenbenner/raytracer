...
Vec3 Scene::Trace(Vec3& pos, Vec3& dir) {
	...
	Vec3 col = shapes[objInd]->getSurfaceColor() * (0.6 + 0.4 * cos(shapes[objInd]->angle(*hitPoint, *hitPoint - pos))); //Scene::ShadowTrace(*hitPoint) ? shapes[objInd]->getSurfaceColor() : Vec3(0, 0, 0
